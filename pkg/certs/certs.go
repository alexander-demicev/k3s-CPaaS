...
func (c Certificates) SaveGenerated(ctx context.Context, ctrlclient client.Client, clusterName client.ObjectKey) error {
	for _, certificate := range c {
		...
		s := certificate.AsSecret(clusterName)
...
func (c Certificates) LookupOrGenerate(ctx context.Context, ctrlclient client.Client, clusterName client.ObjectKey) error {
	...
	if err := c.SaveGenerated(ctx, ctrlclient, clusterName); err != nil {
		return err
	}
...
func (c *Certificate) AsSecret(clusterName client.ObjectKey) *corev1.Secret {
	s := &corev1.Secret{
...
func (c *Certificate) AsFiles() []File {
	out := make([]File, 0)
